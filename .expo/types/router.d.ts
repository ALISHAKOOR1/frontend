...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/Signin/` | `/Signin/` | `/(auth)/Signin` | `/(auth)/Signup/` | `/Signup/` | `/(auth)/Signup` | `/(auth)/Welcome/` | `/Welcome/` | `/(auth)/Welcome` | `/(main)/Audios/` | `/Audios/` | `/(main)/Audios` | `/(main)/ChatBot/` | `/ChatBot/` | `/(main)/ChatBot` | `/(main)/Home/` | `/Home/` | `/(main)/Home` | `/(main)/Profile/` | `/Profile/` | `/(main)/Profile` | `/(main)/Sleep/` | `/Sleep/` | `/(main)/Sleep` | `/.DS_Store`;
  // prettier-ignore
